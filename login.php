...
<body style="background-color:#FFE4C4">
     ...
     <div class="container">
          <div class="row my-5">
               <div class="col-md-6 text-center login bg-warning">
                    <h4 class="fw-bold" style="color: white;">Login Dulu Imuutt:)</h4>
                    ...
                    <form action="" method="post">
                         ...
                         <a href="registrasi.php" class="btn btn-danger text-uppercase"><i class="bi bi-pencil-square"></i>SIGN UP</a>
                    </form>
               </div>
          </div>
     </div>
