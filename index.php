...
<head>
     ...
     <title>Aplikasi Admin Data Siswa</title>
</head>

<body style="background-color:#FFE4C4">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-warning bg-warning text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Data Siswa Malang</a>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                         ...
                         <li class="nav-item">
  <a class="nav-link logout link" id="logout link" href="logout.php" style="color: red; font-weight: bold; background-color: #FFFFFF;">Logout</a>
</li>
